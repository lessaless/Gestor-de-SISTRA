    ...
    const aoEnviar = async (data) => {
        ...
        try {
            ...
            if (!arquivo) {
                ...
                throw new Error("É necessário realizar upload do TEP")
            }
    ...
    return (
        <>
            <div className='formulario-titulo'>
                <h3> Formulário: Termo de Encerramento de Projeto </h3>
            </div>
                ...
                <div className='formulario-content'>
                    ...
                    <div className='linha'>
                        <DirinfraInput
                            ...
                            name='doc_sigadaer'
                            erros={errors}
                            label='Documento SIGADAER do TEP'
                    ...
                    <div className='linha'>
                        <DirinfraTextArea
                            ...
                            erros={errors}
                            label='Observações'
                            placeholder='Digite aqui informações relevantes sobre esse Termo de Encerramento de Projeto que não foram destacadas nos campos anteriores.'
                            registro={register}
                            required={false}
                            a={200}
                        />
