...
const Modelo = "Estudo Técnico Preliminar de Engenharia";
...
const EstudoTPEngenhariaForm = () => {
    ...
    useEffect(() => {
        if (onDesvincular) {
            onDesvincular(() => {
                console.log("ETPE: Desvinculando");
                setIsDesvinculating(true); // ✅ Set flag
