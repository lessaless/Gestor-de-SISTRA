...
/////////////////////////////////////////////////////////////////////////////////////
const AutorForm = ({ register, errors, control, setValue, watch }) => {
			...
			<div style={{ border: '1px solid', borderColor: 'var(--color-borderdefault)', borderRadius: '4px', margin: '0 10px', padding: '2px', width: '100%' }}>
				{fields.map((field, index) => (
					<React.Fragment key={field.id}>
						...
						<div key={'div' + index} className='coluna' style={{ marginTop: '20px', rowGap: '5px' }}>
							...
							<DirinfraInput
								...
								type="number"
								name={`autores.${index}.tempo_gasto`}
								registro={register}
