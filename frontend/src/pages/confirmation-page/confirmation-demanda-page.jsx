...
const ConfirmationPage = () => {
  ...
  const idDemanda = query.get('id_demanda');
  if(!idDemanda) return window.location.href = '/';

  return (
    /* <div style={styles.container}> */
      <DirinfraCard style={styles.card}>
        <DirinfraCardHeader titulo="Confirmação de Demanda" style={styles.header} />
        <DirinfraCardBody style={styles.body}>
          ...
          <h2 style={styles.title}>Demanda Registrada com Sucesso!</h2>
          <p style={styles.message}>
            O identificador da demanda é: <span style={styles.id}>{idDemanda}</span>.
          </p>
          <p style={styles.note}>Por favor, anote esse código para referência futura.</p>
          <div style={styles.buttonContainer}>
            <button className='btn' style={styles.button} onClick={() => window.location.href = '/main/planinfra/listar/demandas'}>
              Ir para a Lista de Demandas
            </button>
          </div>
        </DirinfraCardBody>
      </DirinfraCard>
