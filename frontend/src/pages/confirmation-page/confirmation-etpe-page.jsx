...
const ConfirmationPage = () => {
  ...
  const idETPE = query.get('id_etpe');
  if(!idETPE) return window.location.href = '/';
   ...
   /*  <div style={styles.container}> */
      <DirinfraCard style={styles.card}>
        ...
        <DirinfraCardBody style={styles.body}>
          ...
          <h2 style={styles.title}>Estudo Técnico Preliminar de Engenharia Registrado com Sucesso!</h2>
          <p style={styles.message}>
            O identificador do Estudo Técnico Preliminar de Engenharia é: <span style={styles.id}>{idETPE}</span>.
          </p>
          <p style={styles.note}>Por favor, anote esse código para referência futura.</p>
          <div style={styles.buttonContainer}>
            <button className='btn' style={styles.button} onClick={() => window.location.href = '/main/planinfra/listar/etpes'}>
              Ir para a Lista de ETPEs
            </button>
          </div>
        </DirinfraCardBody>
      </DirinfraCard>
